...
func main() {
	...
	flag.StringVar(&modelUploadJobImage, "model-upload-job-image", "sxwl-registry.cn-beijing.cr.aliyuncs.com/sxwl-ai/uploader:v0.0.2", "the image of model upload job")
	...
	flag.StringVar(&inferenceWebuiImage, "inference-webui-image", "sxwl-registry.cn-beijing.cr.aliyuncs.com/sxwl-ai/chatui:v2.4", "inference webui image")
	flag.StringVar(&inferenceBackendRayImage, "inference-backend-ray-image", "sxwl-registry.cn-beijing.cr.aliyuncs.com/sxwl-ai/ray:v3", "inference webui image")
