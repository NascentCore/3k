...
func (c *CPodJobReconciler) uploadSavedModel(ctx context.Context, cpodjob *v1beta1.CPodJob, modelName string) error {
	...
	resource := "model"
	pvcName := c.GetModelSavePVCName(cpodjob)
	if cpodjob.Annotations != nil {
...
func (c *CPodJobReconciler) GetCKPTPVCName(cpodjob *v1beta1.CPodJob) string {
	return fmt.Sprintf("%s-ckpt", cpodjob.Name)
}
