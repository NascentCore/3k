...
const (
	...
	ModelTypeModelscope  ModelType = "modelscope"
)

type ModelStoragePhase string

const (
	ModelStoragePhaseSyncing ModelStoragePhase = "syncing"
	ModelStoragePhaseDone    ModelStoragePhase = "done"
)
...
type ModelStorageStatus struct {
	...
	// Important: Run "make" to regenerate code after modifying this file
	Phase                 ModelStoragePhase `json:"phase,omitempty"`
	TargetPVCName         string            `json:"targetPvcName,omitempty"`
	TargetDownloadJobName string            `json:"targetDownloadJobName,omitempty"`
