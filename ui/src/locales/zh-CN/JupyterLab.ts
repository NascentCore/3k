...
export default {
  ...
  'pages.jupyterLab.tab.createJupyterLabInstanceButton': '创建实例',
  'pages.jupyterLab.tab.updateJupyterLabInstanceButton': '修改实例',
  ...
  'pages.jupyterLab.JupyterLabTab.table.column.action.runBtn': '启动',
  'pages.jupyterLab.JupyterLabTab.table.column.action.pauseBtn': '暂停',
  'pages.jupyterLab.JupyterLabTab.table.column.action.buildBtn': '构建镜像',
  'pages.jupyterLab.JupyterLabTab.table.column.action.updateBtn': '修改配置',
