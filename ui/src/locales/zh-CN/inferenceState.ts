 ...
 */
export default {
  'pages.inferenceState.table.column.service_name': '推理服务名称',
  'pages.inferenceState.table.column.model_id': '模型名称',
  'pages.inferenceState.table.column.status': '推理服务状态',
  'pages.inferenceState.table.column.url': 'url',
  'pages.inferenceState.table.column.start_time': '启动时间',
