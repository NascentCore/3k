...
export default {
  ...
  'pages.jupyterLab.tab.updateJupyterLabInstanceButton': 'Update JupyterLab Instance',
  ...
  'pages.jupyterLab.JupyterLabTab.table.column.action.updateBtn': 'Update Image',
