...
type (
	...
	SysUserModel interface {
		...
		FindOneByUserID(ctx context.Context, userID string) (*SysUser, error)
...
func (m *defaultSysUserModel) FindOneByUserID(ctx context.Context, userID string) (*SysUser, error) {
	return m.FindOneByQuery(ctx, m.AllFieldsBuilder().Where("new_user_id = ?", userID))
}
...
func (m *defaultSysUserModel) IsAdmin(ctx context.Context, userID string) (bool, error) {
